...
<% if(usertype.equals("System Admin")||usertype.equals("Production"))
 {%>
<li class="root">
 	 <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="margin-left:40px;">Add
 ...
 if(usertype.equals("System Admin")||usertype.equals("Production")||usertype.equals("Management")) { %> 
 	 ...
 	 <li class="root">
 	 	<a class="dropdown-toggle" data-toggle="dropdown" href="#" style="margin-left:40px;">Dash-Board
 ...
 <!-- Production Module Menu item -->
 	<li class="root">
 	   <a href="#" class="dropdown-toggle"   data-toggle="dropdown" style="margin-left:40px;">Production Module<span class="glyphicon glyphicon-object-align-bottom" ></span></a>
 	   <ul class="dropdown-menu">
 	 <% if(roles.contains("Wheel")||roles.equals("All"))  {%>
...
<li class="root">
<a href="#" class="dropdown-toggle"   data-toggle="dropdown" style="margin-left:40px;">Maintenance<span class="glyphicon glyphicon-object-align-bottom" ></span></a>
	 	 <ul class="dropdown-menu"> 
 	 	 <li class="dropdown-submenu">
...
<li class="root">
 	<a href="#" class="dropdown-toggle"   data-toggle="dropdown" style="margin-left:40px;">Manpower Utilization<span class="glyphicon glyphicon-object-align-bottom" ></span></a>
 	 	 <ul class="dropdown-menu">
...
<li class="root">
 	<a href="#" class="dropdown-toggle"   data-toggle="dropdown" style="margin-left:40px;">Furnishing Stage Clearance<span class="glyphicon glyphicon-object-align-bottom" ></span></a>
 		    <ul class="dropdown-menu">	
 	  		 	 <li><a href="furnishingStageClearance">Furnishing Stage Clearance</a></li> 
 		    </ul>	 
</li>
...
<ul class="nav navbar-nav navbar-right">
      <li class="root">
<a class="dropdown-toggle" data-toggle="dropdown" href="#" style="margin-right:60px;">Account<span class="glyphicon glyphicon-user"></span></a>
