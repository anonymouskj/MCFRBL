	...
	<div id="ParitionFrame" class="tabcontent">
	   <form name="ParitionFrame">	
		<table border="1">
			...
			<tr><td>1.</td><td>Dent mark on partition BN</td><td colspan="2"><input type="text" id="" name=""></td><td>Excess cut</td><td colspan="2"><input type="text" id="" name=""></td></tr>
			<tr><td>2.</td><td>Excess gap between U moulding and partition pillar BN</td><td colspan="5"><input type="text" id="" name=""></td></tr>
			<tr><td>3.</td><td>Middle berth stopper missing</td><td><input type="text" id="" name=""></td><td>Loose</td><td><input type="text" id="" name=""></td><td>Rubber pad missing</td><td><input type="text" id="" name=""></td></tr>
			<tr><td>4.</td><td>Partition pillar mounting hardware loose</td><td><input type="text" id="" name=""></td><td>Missing</td><td><input type="text" id="" name=""></td><td>Taper</td><td><input type="text" id="" name=""></td></tr>
			<tr><td>5.</td><td>Unwanted holes on partition</td><td colspan="2"><input type="text" id="" name=""></td><td>Plastic film not removed from partition</td><td colspan="2"><input type="text" id="" name=""></td></tr>
			<tr><td>6.</td><td>Roughly putty applied on partition</td><td colspan="5"><input type="text" id="" name=""></td></tr>
			<tr><td>7.</td><td>Partition pillar U moulding Zigzag</td><td colspan="2"><input type="text" id="" name=""></td><td>Not properly sited</td><td colspan="2"><input type="text" id="" name=""></td></tr>
			<tr><td>8.</td><td>Burr found on partition pillar</td><td colspan="2"><input type="text" id="" name=""></td><td>Berth holding bkt</td><td colspan="2"><input type="text" id="" name=""></td></tr>
		</table>
		<h3>Testing Observations</h3>
...
/*  $("#selectStages").dialog({
    ...
    buttons: {
    	 ...
    	 Submit: {
             ...
             click:function () {
            	if(btn==1){
            		 var c=confirm("Do you want to submit data1");
                	...
                	
            		{
            		    ...
            		    click: function () {
            		    	 ...
            		    	 if ($selectedRows.length<1)
                        		 alert("Please select a row for which you want to Perform  Quality Check");
            		    	 else {
            		     var record;
